...
headerPanel(
  title = tags$a(
    href = 'https://deq.utah.gov/division-water-quality/',
    tags$img(
      src = 'deq_dwq_logo_draft.png',
      height = 125,
      width = 100 * 2.85 * 1.75
    ),
    target = "_blank"
...
server <- function(input, output, session){
	...
	observe({
		...
		print(profile_dates) #____________________________________________
		str(reactive_objects$profile_dates)
	})
	...
	#	print(reactive_objects$selectedActID)
	#	print(reactive_objects$sel_profiles$ActivityIdentifier)
	})
